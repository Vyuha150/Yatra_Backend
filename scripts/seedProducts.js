...
const products = [
  ...
  },
  {
    ...
    description: "yatra’s public transport Escalators are reliable, moreover, It has high energy efficient resources to strive for innovation, with customizable speed ranges (up to 2.5 m/s), intelligent door operation, and superior leveling accuracy developed  for malls, office complexes, convention centres, and public spaces. Our elevators and escalators are equipped with facilities like durability,  lift mobility, Advanced Sensors, Safety Features and Optional Customizations. The walkways and transport system are cozy.",
    features: [
